...
//Håndterer funksjon fra logg inn knappen til index
@WebServlet("/loggInn")
...
// Dette blir en Post ettersom vi vil sjekke noe vi skriver inn imot noe som ligger inne i DB
    public void doPost(HttpServletRequest req, HttpServletResponse res) throws IOException {
        ...
        //Her lager vi en tom BrukerDB modell, som håndterer data til/fra databasen
        BrukerDB bdb = null;
        try {
            ...
            //Her kombinerer vi Bruker modellen med BrukerDB modellen, slik at vi fyller en bruker med data fra DB
